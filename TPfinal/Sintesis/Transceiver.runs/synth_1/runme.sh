...
HD_PWD='/home/raxt/CESE_Workspace/CLP_workspace/TPfinal/Sintesis/Transceiver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transceriver_impl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transceriver_impl.tcl
