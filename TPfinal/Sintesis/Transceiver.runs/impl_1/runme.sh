...
HD_PWD='/home/raxt/CESE_Workspace/CLP_workspace/TPfinal/Sintesis/Transceiver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log transceriver_impl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source transceriver_impl.tcl -notrace
